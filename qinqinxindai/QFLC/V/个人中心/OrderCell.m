...
- (void)CreatOrderCell{
    ...
    ///订单类型
    self.typeLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.timeLabel.right, APP_HEIGHT_6S(13.0), APP_WIDTH_6S(110.0), APP_HEIGHT_6S(14.0))];
    
    _typeLabel.textColor = ThemeColor;
    _typeLabel.textAlignment = NSTextAlignmentRight;
    _typeLabel.font = [UIFont systemFontOfSize:APP_HEIGHT_6S(12.0)];
    [bg addSubview:_typeLabel];
...
//    }
    ...
    self.typeLabel.text = orderModel.pay_type_name;
}
