...
+(YDButton *)buttonWithFrame:(CGRect)frame
    ...
    yxbBtn.layer.cornerRadius = frame.size.height/2.0;
    return yxbBtn;
...
- (void)setYdTitle:(NSString *)ydTitle{
    [self setTitle:ydTitle forState:UIControlStateNormal];
}
